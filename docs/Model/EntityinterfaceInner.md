...
**routes** | **array<string,mixed>** | Map of resolved route identifiers to URL paths, for example &#x60;routes.detail &#x3D; \&quot;/foo-bar\&quot;&#x60;. Includes the system key &#x60;_empty&#x60; (boolean): &#x60;false&#x60; means at least one route could be resolved, &#x60;true&#x60; means no route is available for the current context. | [optional]

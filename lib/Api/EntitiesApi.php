...
/**
     ...
     */
    public function entityBySlug($slug, $type_id = null, string $contentType = self::contentTypes['entityBySlug'][0])
    {
        list($response) = $this->entityBySlugWithHttpInfo($slug, $type_id, $contentType);
        return $response;
    }
     ...
     */
    public function entityBySlugWithHttpInfo($slug, $type_id = null, string $contentType = self::contentTypes['entityBySlug'][0])
    {
        $request = $this->entityBySlugRequest($slug, $type_id, $contentType);
     ...
     */
    public function entityBySlugAsync($slug, $type_id = null, string $contentType = self::contentTypes['entityBySlug'][0])
    {
        return $this->entityBySlugAsyncWithHttpInfo($slug, $type_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function entityBySlugAsyncWithHttpInfo($slug, $type_id = null, string $contentType = self::contentTypes['entityBySlug'][0])
    {
        $returnType = '\Flyo\Model\Entity';
        $request = $this->entityBySlugRequest($slug, $type_id, $contentType);
     ...
     */
    public function entityBySlugRequest($slug, $type_id = null, string $contentType = self::contentTypes['entityBySlug'][0])
    {
     ...
     * @return \Flyo\Model\Entity
     */
    public function entityByUniqueid($uniqueid, string $contentType = self::contentTypes['entityByUniqueid'][0])
    {
        list($response) = $this->entityByUniqueidWithHttpInfo($uniqueid, $contentType);
        return $response;
    }
     ...
     * @return array of \Flyo\Model\Entity, HTTP status code, HTTP response headers (array of strings)
     */
    public function entityByUniqueidWithHttpInfo($uniqueid, string $contentType = self::contentTypes['entityByUniqueid'][0])
    {
        $request = $this->entityByUniqueidRequest($uniqueid, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function entityByUniqueidAsync($uniqueid, string $contentType = self::contentTypes['entityByUniqueid'][0])
    {
        return $this->entityByUniqueidAsyncWithHttpInfo($uniqueid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function entityByUniqueidAsyncWithHttpInfo($uniqueid, string $contentType = self::contentTypes['entityByUniqueid'][0])
    {
        $returnType = '\Flyo\Model\Entity';
        $request = $this->entityByUniqueidRequest($uniqueid, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function entityByUniqueidRequest($uniqueid, string $contentType = self::contentTypes['entityByUniqueid'][0])
    {

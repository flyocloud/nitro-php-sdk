...
class EntitiesApi
{
    ...
    public function entityBySlugWithHttpInfo($slug, $type_id = null, $lang = null, string $contentType = self::contentTypes['entityBySlug'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Flyo\Model\Entity' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Flyo\Model\Entity' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Flyo\Model\Entity', []),

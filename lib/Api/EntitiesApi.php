...
class EntitiesApi
{
     ...
     */
    public function entityBySlug($slug, $lang = null, $type_id = null, string $contentType = self::contentTypes['entityBySlug'][0])
    {
        list($response) = $this->entityBySlugWithHttpInfo($slug, $lang, $type_id, $contentType);
        return $response;
    }
     ...
     */
    public function entityBySlugWithHttpInfo($slug, $lang = null, $type_id = null, string $contentType = self::contentTypes['entityBySlug'][0])
    {
        $request = $this->entityBySlugRequest($slug, $lang, $type_id, $contentType);
     ...
     */
    public function entityBySlugAsync($slug, $lang = null, $type_id = null, string $contentType = self::contentTypes['entityBySlug'][0])
    {
        return $this->entityBySlugAsyncWithHttpInfo($slug, $lang, $type_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function entityBySlugAsyncWithHttpInfo($slug, $lang = null, $type_id = null, string $contentType = self::contentTypes['entityBySlug'][0])
    {
        $returnType = '\Flyo\Model\Entity';
        $request = $this->entityBySlugRequest($slug, $lang, $type_id, $contentType);
     ...
     */
    public function entityBySlugRequest($slug, $lang = null, $type_id = null, string $contentType = self::contentTypes['entityBySlug'][0])
    {

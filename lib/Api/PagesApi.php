...
class PagesApi
{
     ...
     * @return \Flyo\Model\Page
     */
    public function page($lang = null, $slug = null, string $contentType = self::contentTypes['page'][0])
    {
        list($response) = $this->pageWithHttpInfo($lang, $slug, $contentType);
        return $response;
    }
     ...
     * @return array of \Flyo\Model\Page, HTTP status code, HTTP response headers (array of strings)
     */
    public function pageWithHttpInfo($lang = null, $slug = null, string $contentType = self::contentTypes['page'][0])
    {
        $request = $this->pageRequest($lang, $slug, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pageAsync($lang = null, $slug = null, string $contentType = self::contentTypes['page'][0])
    {
        return $this->pageAsyncWithHttpInfo($lang, $slug, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pageAsyncWithHttpInfo($lang = null, $slug = null, string $contentType = self::contentTypes['page'][0])
    {
        $returnType = '\Flyo\Model\Page';
        $request = $this->pageRequest($lang, $slug, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function pageRequest($lang = null, $slug = null, string $contentType = self::contentTypes['page'][0])
    {

...
class SitemapApi
{
    ...
    {
        list($response) = $this->sitemapWithHttpInfo($lang, $contentType);
        return $response;
    }
     ...
     */
    public function sitemapAsync($lang = null, string $contentType = self::contentTypes['sitemap'][0])
    {
        return $this->sitemapAsyncWithHttpInfo($lang, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function sitemapRequest($lang = null, string $contentType = self::contentTypes['sitemap'][0])
    {

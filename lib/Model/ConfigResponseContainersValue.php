...
class ConfigResponseContainersValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'items' => '\Flyo\Model\ContainerPage[]',
        'uid' => 'string',
        'identifier' => 'string',
        'label' => 'string'
    ];

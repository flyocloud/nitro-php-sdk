...
/**
 * EntityInterface Class Doc Comment
 *
 * @category Class
 * @package  Flyo
 ...
 */
class EntityInterface implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Entity_Interface';
    ...
    protected static $openAPITypes = [
        '_version' => 'float',
        'entity_metric' => '\Flyo\Model\EntityMetric',
        'entity_unique_id' => 'string',
        'entity_id' => 'float',
        'entity_image' => 'string',
        'entity_slug' => 'string',
        'entity_teaser' => 'string',
        'entity_time_end' => 'float',
    ...
    */
     ...
     * Gets entity_metric
     *
     * @return \Flyo\Model\EntityMetric|null
     */
     ...
     * Sets entity_metric
     *
     * @param \Flyo\Model\EntityMetric|null $entity_metric entity_metric
     *
     * @return self
     */
     ...
     * Sets entity_id
     *
     * @param float|null $entity_id An unique ID across the flyo sytem
     *
     * @return self
     */
     ...
     *
     * @param float|null $entity_time_end The shared entity interface time end attribute. If not defined, null or 0 is returned
     *
     * @return self
     */

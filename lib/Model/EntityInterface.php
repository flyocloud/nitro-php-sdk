...
class EntityInterface implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets entity_id
     *
     * @param string|null $entity_id An unique ID across the flyo sytem
     *
     * @return self
     */
     ...
     *
     * @param string|null $entity_time_end Unique ID
     *
     * @return self
     */
     ...
     *
     * @param string|null $entity_time_start If not defined, null is returned
     *
     * @return self
     */

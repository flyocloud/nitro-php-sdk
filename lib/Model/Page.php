...
class Page implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The ID for the page
     *
     * @return self
     */
     ...
     * Sets depth
     *
     * @param int|null $depth The depth of the page in the tree structure
     *
     * @return self
     */
     ...
     * Sets is_home
     *
     * @param int|null $is_home Determining whether the page is the homepage or not.
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param int|null $created_at A Unix timestamp indicating when the page was created.
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param int|null $updated_at A Unix timestamp indicating when the page was last updated.
     *
     * @return self
     */
     ...
     * Sets is_visible
     *
     * @param int|null $is_visible Determining whether the page is visible or not.
     *
     * @return self
     */
     ...
     * Gets properties
     *
     * @return array<string,\Flyo\Model\PagePropertyValue>|null
     */
     ...
     * Sets properties
     *
     * @param array<string,\Flyo\Model\PagePropertyValue>|null $properties properties
     *
     * @return self
     */
